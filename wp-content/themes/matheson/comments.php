...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 id="comments-title">
			...
			<?php
				printf( _n( '1 comment for &ldquo;%2$s&rdquo;', '%1$s comments for &ldquo;%2$s&rdquo;', get_comments_number(), 'matheson' ),
		...
		<p class="nocomments"><?php _e( 'Comments are closed.' , 'matheson' ); ?></p>
		<?php endif; ?>
