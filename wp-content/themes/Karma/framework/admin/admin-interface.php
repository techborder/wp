...
<div id="main">
	...
	<div id="tt-options-content-wrap">
    	<h2 class="truethemes-admin-logo">
			<?php _e('Site Options','truethemes_localize'); ?> <a class="add-new-h2" href="https://support.truethemes.net" target="_blank"><?php _e('Theme Support &rarr;','truethemes_localize'); ?></a></h2>
