...
function optionsframework_options() {
   ...
   // HEADER
	...
	$options[] = array(
		...
		'desc' => __('Active custom home page layout.  The standardized way of creating Static Front Pages: <a href="'.esc_url('http://codex.wordpress.org/Creating_a_Static_Front_Page').'" target="_blank">Creating a Static Front Page</a>', 'meris'),
		'id' => 'enable_home_page',
		'std'=>'',
		'type' => 'checkbox');
