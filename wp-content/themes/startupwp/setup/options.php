...
<label class="description" for="startup_options[slider]"><?php _e( 'Universal Slider', 'startup' ); ?> <em>(<?php printf(__( 'important: you must create a slider first after installing %1$s Nivo Slider for WordPress %2$s - for best results set slider to and prepare images at 1000px wide [or whatever you have set your max display width to] and 200px or more high - all slides need to be consistent in size', 'startup' ), '<a href="plugin-install.php?tab=search&s=Nivo+Slider+for+WordPress" target="_blank">', '</a>' ); ?>)</em></label>
<br />
