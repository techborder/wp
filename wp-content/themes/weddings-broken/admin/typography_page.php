...
class web_dor_typography_page_class{
	...
	function __construct(){
		...
		$this->shorttypography = $special_id_for_db."ty";	
		  ...
		  foreach($this->options_typography as $key=>$spec_font)
		  {
		   if(isset($spec_font['name'])){
		    if($spec_font['name']=='Select Font'){
				  $wp_customize->add_setting( 'theme_mods_weddings['.$spec_font['id'].']', array(
					'default'   => $spec_font['std'],
					'type'      => 'option',
					'capability'  => 'edit_theme_options',
					'transport'   => 'postMessage'
				  ) );
				  $wp_customize->add_control( 'theme_mods_weddings['.$spec_font['id'].']', array(
					'label'   => $spec_font['name_customize'],
					'section' => 'fonts',
					'settings'  => 'theme_mods_weddings['.$spec_font['id'].']',
					'type'    => 'select',
	...
	public function web_dorado_typography_page_admin_scripts(){
		...
		wp_enqueue_style('typagraphi_page_main_style',get_bloginfo('template_directory').'/admin/css/typography_page.css');	
	...
	public function dorado_theme_admin_typography(){
		...
		<table align="center" width="90%" style="margin-top: 0px; margin-bottom: 23px;border-bottom: rgb(111, 111, 111) solid 2px;">
					<tr>
						<td>
							<h3 style="margin: 0px;font-family:Segoe UI;padding-bottom: 15px;color: rgb(111, 111, 111); font-size:18pt;"><?php echo $value['name']; ?></h3>
						</td>
		...
		<div>
			...
			<div>
				...
				<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_headers_font'],$class='fontselector'); ?>
				</div>
				<div>
					...
					<div id="type_headers_set_styling" class="font_styling type_inputs optioninputtextarea" style="height: 110px;">
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_headers_kern'],$class='letter_spacing'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_headers_transform'],$class='text_transform'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_headers_variant'],$class='font_variant'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_headers_weight'],$class='font_weight'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_headers_style'],$class='font_style'); ?>
						</div>
						<div class="clear"></div>
					</div>
				</div>
		...
		<div>
			<div class="optiontitle">
				...
				<div>
					<div class="optioninput" style=" font-size:13pt;">
						<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_primary_font'],$class='fontselector'); ?>
					<div>
				</div>
			</div>
			<div class="font_preview_wrap">
			...
			<div id="_type_primary__set_styling" class="font_styling type_inputs optioninputtextarea" style="height:110px;">
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_primary_kern'],$class='letter_spacing'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_primary_transform'],$class='text_transform'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_primary_variant'],$class='font_variant'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_primary_weight'],$class='font_weight'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_primary_style'],$class='font_style'); ?>
						</div>
				<div class="clear"></div>
			</div>
		</div>
		...
		<br/>
			<div>
				...
				<div>
					<div class="optioninput" style=" font-size:13pt;">
						<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_font'],$class='fontselector'); ?>
					</div>
					<div>
						<div class="font_preview_wrap">
							<label class="typagrphy_label" for="" style="font-size:18px;font-size: 20px;font-family: Segoe UI;">Preview</label>
						...
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_kern'],$class='letter_spacing'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_transform'],$class='text_transform'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_variant'],$class='font_variant'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_weight'],$class='font_weight'); ?>
						</div>
						<div class="type_select">
							<?php $dor_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_style'],$class='font_style'); ?>
						</div>
						<div class="clear"></div>
						</div>
