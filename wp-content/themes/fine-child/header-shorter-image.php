...
<div class="full-width-container header-full-width">
	...
	<?php $header_image = cyberchimps_get_option( 'header_image', get_template_directory_uri() . '-child' . '/images/header-shorter.png' );
	$header_image = ( $header_image != '' ) ? $header_image : get_template_directory_uri() . '/images/header-shorter.png'; 
	$header_image = get_template_directory_uri() . '-child' . '/images/header-shorter.png'; //DEBUG?>

	<img class="header-image-shorter" src="<?php echo esc_url( $header_image ); ?>" alt="Image"/>
