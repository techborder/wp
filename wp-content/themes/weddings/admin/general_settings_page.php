...
class web_dor_general_settings_page_class{
	...
	function __construct(){
		...
		global $special_id_for_db, $web_dor;
		/// initial params
		$this->generalsettings = "General Settings";
		$this->shortgeneralsettings = $special_id_for_db."";
		...
		$value_of_std[17] = get_theme_mod($this->shortgeneralsettings."_footer_text", '<span id="copyright">WordPress Themes by <a href="'.$web_dor.'/wordpress-themes"  target="_blank" title="Web-Dorado">Web-Dorado</a></span>');
				...
				<table align="center" width="90%" style=" padding-bottom:0px; padding-top:0px;">
					<tr>
						<td>
							...
							<?php 
								$dor_admin_helepr_functions->only_textarea($this->options_generalsettings['custom_css']); 
								$dor_admin_helepr_functions->only_upload($this->options_generalsettings['logo_img']);
								$dor_admin_helepr_functions->checkbox_with_upload($this->options_generalsettings['favicon_enable'],$this->options_generalsettings["favicon_img"]); 
								$dor_admin_helepr_functions->only_checkbox($this->options_generalsettings['blog_style']); 
								$dor_admin_helepr_functions->only_checkbox($this->options_generalsettings['grab_image']); 
								$dor_admin_helepr_functions->checkbox_with_input($this->options_generalsettings['show_twitter_icon'],$this->options_generalsettings['twitter_url']); 
								$dor_admin_helepr_functions->checkbox_with_input($this->options_generalsettings['show_rss_icon'],$this->options_generalsettings['rss_url']); 
								$dor_admin_helepr_functions->checkbox_with_input($this->options_generalsettings['show_facebook_icon'],$this->options_generalsettings['facebook_url']); 
								$dor_admin_helepr_functions->only_checkbox($this->options_generalsettings['date_enable']); 
								$dor_admin_helepr_functions->only_textarea($this->options_generalsettings['footer_text']); 
							?>
							</div>		
						</td>
					</tr>
