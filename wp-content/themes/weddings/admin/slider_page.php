	...
	public function dorado_theme_admin_slider(){
		...
		<div id="main_slider_page">
			<div class="wrap" style="margin-right:76px; margin-left: 82px;">
				<table align="center" width="90%" style="margin: 0px;">
					<tr>
						<td>
							<h2 style="margin:15px 0px 0px;font-family:Segoe UI;padding-bottom: 10px;color: rgb(111, 111, 111); font-size:28pt;">Slider</h2>
						</td>
					</tr>
					<tr>   
						<td style="font-size:14px; font-weight:bold; padding-left: 5px;">
							<a href="<?php echo esc_url($weddings_web_dor).'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;">User Manual</a><br />This section allows you customize the slider.
							<a href="<?php echo esc_url($weddings_web_dor).'/wordpress-theme-options/3-8.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;">More...</a>
						</td>  
