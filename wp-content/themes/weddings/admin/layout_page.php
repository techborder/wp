...
class weddings_layout_page_class{
	...
	function __construct(){
		...
		$this->shortthemeoptions = $weddings_special_id_for_db."gs";
					...
					<tr>
						<td>
							...
							<table width="100%">
						     ...
						     <div>
								<?php	$weddings_admin_helepr_functions->only_checkbox($this->options_themeoptions['full_width']); ?>
								<?php for($i=0;$i<$count_text;$i++) {
									$weddings_admin_helepr_functions->only_input($text[$i],array("input_size"=>"4"));
								 } 			
								 ?>
