...
class web_dor_slider_page_class{
	...
	public function web_dorado_slider_page_admin_scripts(){
		...
		wp_enqueue_style('color_control_page_main_style',get_bloginfo('template_directory').'/admin/css/slider_page.css');	
			...
			<table align="center" width="90%" style="margin-left: 0;margin-right: 0;margin-top: 0px; margin-bottom: 23px;border-bottom: rgb(111, 111, 111) solid 2px;">
					<tr>
						...
						<td style="padding-left: 10px;width: 36%;font-size:14px; font-weight:bold">
                          ...
                          <a href="<?php echo $web_dor.'/wordpress-theme-options/3-8.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;">More...</a>
					    </td>
					</tr>
				</table>		
		<?php	
