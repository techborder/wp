...
<div id="comments" class="comments-area<?php if ( $liveride_options_db['liveride_next_preview_post'] == 'Display' || $liveride_options_db['liveride_next_preview_post'] == '' ) { ?> comments-area-post<?php } ?>">
