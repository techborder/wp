...
<?php if( isset($blogBox_options['bB_show_favicon']) && $blogBox_options['bB_show_favicon'] == 1 ) echo '<link rel="shortcut icon" href="'. get_template_directory_uri().'/favicon.png" />'; ?>
<?php wp_head(); ?>
</head>
