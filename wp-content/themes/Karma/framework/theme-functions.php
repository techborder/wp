...
function tt_before_signup_form(){
			...
			if('true' == $tt_custom_primary):
			function tt_custom_primary_head() {
				echo '<link href="'.get_stylesheet_directory_uri().'/css/_custom_color_scheme_primary.php" rel="stylesheet">';	
			}
			add_action('wp_head', 'tt_custom_primary_head');
			...
			if('true' == $tt_custom_secondary):
			function tt_custom_secondary_head() {
				echo '<link href="'.get_stylesheet_directory_uri().'/css/_custom_color_scheme_secondary.php" rel="stylesheet">';	
			}
			add_action('wp_head', 'tt_custom_secondary_head');
