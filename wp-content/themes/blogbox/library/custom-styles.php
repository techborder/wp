...
if( $blogBox_options['bB_use_skin'] && $blogBox_options['bB_use_skin'] == true ){
	...
	<style type="text/css" >
		...
		#feature-area a,#widecolumn a,#widecolumn-right a,#fullwidth a,#fullwidth-blog a,#sidebar a {
			color: <?php echo esc_html( $blogBox_options['bB_main_link_color'] ); ?>;}
		#feature-area a:hover,#widecolumn a:hover,#widecolumn-right a:hover,#fullwidth a:hover,#fullwidth-blog a:hover,#sidebar a:hover {
