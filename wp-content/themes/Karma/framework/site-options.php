...
$options[] = array(
			...
			"desc" => __('Disable to Speed up site loading! If you are not using the exclude categories option found below, Please check this box to disable it. This will prevent unnecessary database queries','truethemes_localize'),
...
$options[] = array(
			...
			"desc"    => __('Select any categories that you\'d like to hide from the blog. Will not work if above option is disabled. This option generates substantial amount of database query. ','truethemes_localize'),
