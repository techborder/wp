...
<div class="set-business" <?php if ( empty( $location ) ) {
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'reference' ); ?>"><?php _e( 'Location Reference ID', 'gpr' ); ?>
			:</label>
		<input class="widefat reference" onClick="this.setSelectionRange(0, this.value.length)" readonly id="<?php echo $this->get_field_id( 'reference' ); ?>"
...
<div class="review-options toggle-item">
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'review_filter' ); ?>"><?php _e( 'Minimum Review Rating:', 'gpr' ); ?>
			<img src="<?php echo GPR_PLUGIN_URL . '/assets/images/help.png' ?>"
			     title="<?php _e( 'Filter bad reviews to prevent them from displaying. Please note that the Google Places API only allows for up to 5 total reviews displayed per location. This option may limit the total number further.', 'gpr' ); ?>"
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'review_limit' ); ?>"><?php _e( 'Limit Number of Reviews:', 'gpr' ); ?>
			<img src="<?php echo GPR_PLUGIN_URL . '/assets/images/help.png' ?>"
			     title="<?php _e( 'Limit the number of reviews displayed for this location to a set number.', 'gpr' ); ?>"
			     class="tooltip-info" width="16" height="16" /></label>
	...
	<p class="limit-reviews-option">
		...
		<label for="<?php echo $this->get_field_id( 'reviewers_link' ); ?>"><?php _e( 'Link to Reviewer\'s Google+ Page', 'gpr' ); ?>
			<img src="<?php echo GPR_PLUGIN_URL . '/assets/images/help.png' ?>"
			     title="<?php _e( 'Toggle on or off the link on the reviews name to their Google+ page.', 'gpr' ); ?>"
			     class="tooltip-info" width="16" height="16" /></label>
	</p>
	...
	<p class="review-character-limit" <?php if($review_characters == '1') { ?>style="display:block;"<?php } ?>>
		<label for="<?php echo $this->get_field_id( 'review_char_limit' ); ?>"><?php _e( 'Review Character Limit', 'gpr' ); ?><img src="<?php echo GPR_PLUGIN_URL . '/assets/images/help.png' ?>" title="<?php _e( 'Set the character limit for this review widget. Values are in pixels.', 'gpr' ); ?>" class="tooltip-info" width="16" height="16" /></label>
