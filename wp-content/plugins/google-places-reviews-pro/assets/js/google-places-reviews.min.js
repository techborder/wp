!function(a){a(document).ready(function(){a(".gpr-widget-inner").each(function(){var b=a(this).find(".gpr-review-content"),c=a(this).data("review-limit");"undefined"!=typeof c&&c||(c=250),b.readmore({maxHeight:parseInt(c)})})})}(jQuery);
