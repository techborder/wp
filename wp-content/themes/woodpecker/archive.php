...
<div class="page-top-bg">
    <div class="container">
        <div class="row">
            <div class="brd-crm"><h1> <?php if (is_day()) : ?>
                        <?php printf(WOODPECKER_DAILY_ARCHVIES, get_the_date()); ?>
                    <?php elseif (is_month()) : ?>
                        <?php printf(WOODPECKER_MONTHLY_ARCHIVES, get_the_date('F Y')); ?>
                    <?php elseif (is_year()) : ?>
                        <?php printf(WOODPECKER_YEARLY_ARCHIVES, get_the_date('Y')); ?>
                    <?php else : ?>
                        <?php echo WOODPECKER_BLOG_ARCHIVES; ?>
                    <?php endif; ?></h1></div>
        </div>
    </div>
