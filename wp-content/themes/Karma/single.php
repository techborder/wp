...
echo '</ul>'; }
//it's undefined variable and not used anywhere in this file..I (Denzel) did not remove, because I do not know what it is it's purpose..just suppress the error.
@$post = $backup;
wp_reset_query();
