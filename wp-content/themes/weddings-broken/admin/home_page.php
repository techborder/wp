...
class web_dor_home_page_class{
	...
	function __construct(){
	  global $special_id_for_db;
		...
		$this->shorthomepage = $special_id_for_db;
		...
		$value_of_std[8]=get_theme_mod($this->shorthomepage."_cat_name",'Testimonials');
		...
		$this->options_homepage = array(
			...
			"n_of_home_post" => array(
			
				"name" => "Number of Posts",
				
				"description" => "",
				
				"var_name" => "n_of_home_post",

				"id" => $this->shorthomepage."_n_of_home_post",
			...
			"hide_about_us" => array(
				...
				"description" => "Using this option, you can hide the ...............",
	...
	public function dorado_theme_admin_home(){
		...
		<div id="main_home_page">
			...
			<table align="center" width="90%" style="margin-top: 0px; margin-bottom: 20px; border-bottom: rgb(111, 111, 111) solid 2px;">
				<tr>
					<td colspan="2"><h3  style="margin: 0px;font-family:Segoe UI;padding-bottom: 15px;border-bottom: rgb(111, 111, 111) solid 2px;color: rgb(111, 111, 111); font-size:18pt;">Home</h3>
					</td>
				</tr>
			</table>
			<form method="post"  action="themes.php?page=web_dorado_theme&controller=home_page">
				<table align="center" width="90%" style=" padding-bottom:0px; padding-top:0px;">
					<tr>
						<td>
							<?php 							
								//$dor_admin_helepr_functions->only_checkbox($this->options_homepage['hide_slider']);  /// Home Number of posts
								$dor_admin_helepr_functions->only_category_checkboxses($this->options_homepage['content_post']);  /// Home content posts
								
								$dor_admin_helepr_functions->checkbox_category_checkboxses($this->options_homepage['hide_top_posts'],$this->options_homepage['top_post_categories']);  /// Home Top posts
								$dor_admin_helepr_functions->only_input($this->options_homepage['categories_name']);  /// Home Number of posts
								$dor_admin_helepr_functions->only_input($this->options_homepage['n_of_home_post']);  /// Home Number of posts
								
								$dor_admin_helepr_functions->only_category_checkboxses($this->options_homepage['content_post_categories']);  /// Home content posts
								$dor_admin_helepr_functions->only_input($this->options_homepage['cat_name']);  
								$dor_admin_helepr_functions->only_input($this->options_homepage['n_of_testimonials']);  /// Testimonials Number of posts
								$dor_admin_helepr_functions->only_category_checkboxses($this->options_homepage['content_post_cats']);  /// Home content posts
							?>						
						</td>
					</tr>
				</table>
