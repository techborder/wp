        ...
        <div class="grid_24">
            <div class="page_heading_content">
                ...
                <?php if (have_posts()) : the_post(); ?>
                    <p><?php printf(AUTHOR_ARCHIVES, "<span class='vcard'><a class='url fn n' href='" . get_author_posts_url(get_the_author_meta('ID')) . "' title='" . esc_attr(get_the_author()) . "' rel='me'>" . get_the_author() . "</a></span>"); ?></p>
                </div>
            </div>
            <div class="clear"></div>
        </div>
