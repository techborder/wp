	...
	function init() {
		if (function_exists('load_plugin_textdomain')) {
			if ( !defined('WP_PLUGIN_DIR') ) {
				//suppress by TT
				// load_plugin_textdomain('truethemes_localize', str_replace( ABSPATH, '', dirname(__FILE__)));
			} else {
				//suppress by TT
				// load_plugin_textdomain('truethemes_localize', false, dirname(plugin_basename(__FILE__)));
			}
		}
		...
		/*
		if (function_exists('load_plugin_textdomain')) {
			load_plugin_textdomain('truethemes_localize', WP_PLUGIN_DIR . '/all-in-one-seo-pack');
		}
*/
...
?>
		...
		<?php _e('SEO Module', 'truethemes_localize') ?>
		</th>
		</tr>
		<tr>
		<th width="33%" scope="row" valign="top"><label for="aiosp_title"><?php _e('Title:', 'truethemes_localize') ?></label></th>
		<td><input value="<?php echo $title ?>" type="text" name="aiosp_title" size="70"/></td>
		</tr>
		<tr>
		<th width="33%" scope="row" valign="top"><label for="aiosp_keywords"><?php _e('Keywords (comma separated):', 'truethemes_localize') ?></label></th>
...
?>
	 ...
	 <?php if (substr($this->wp_version, 0, 3) >= '2.5') { ?>
                <div id="postaiosp" class="postbox closed">
                	<h3><?php _e('All in One SEO Pack', 'truethemes_localize') ?></h3>
                	<div class="inside">
                		<div id="postaiosp">
                <?php } else { ?>
                			<div class="dbx-b-ox-wrapper">
                				<fieldset id="seodiv" class="dbx-box">
                					<div class="dbx-h-andle-wrapper">
                						<h3 class="dbx-handle"><?php _e('All in One SEO Pack', 'truethemes_localize') ?></h3>
                					</div>
                					<div class="dbx-c-ontent-wrapper">
                						<div class="dbx-content">
                <?php } ?>

				<a target="__blank" href="http://semperfiwebdesign.com/portfolio/wordpress/wordpress-plugins/all-in-one-seo-pack/"><?php _e('Click here for Support', 'truethemes_localize') ?></a>
				<input value="aiosp_edit" type="hidden" name="aiosp_edit" />
				<table style="margin-bottom:40px">
					...
					<tr>
						<th scope="row" style="text-align:right;"><?php _e('Title:', 'truethemes_localize') ?></th>
						<td><input value="<?php echo $title ?>" type="text" name="aiosp_title" size="62"/></td>
					</tr>
					<tr>
						<th scope="row" style="text-align:right;"><?php _e('Description:', 'truethemes_localize') ?></th>
						<td><textarea name="aiosp_description" rows="1" cols="60" onKeyDown="countChars(document.post.aiosp_description,document.post.length1)"	onKeyUp="countChars(document.post.aiosp_description,document.post.length1)"><?php echo $description ?>
							...
							<?php _e(' characters. Most search engines use a maximum of 160 chars for the description.', 'truethemes_localize') ?>
						</td>
					</tr>
					<tr>
						<th scope="row" style="text-align:right;"><?php _e('Keywords (comma separated):', 'truethemes_localize') ?></th>
					...
					<?php if ($this->is_admin()) { ?>
						<tr>
							<th scope="row" style="text-align:right; vertical-align:top;">
								<?php _e('Disable on this page/post:', 'truethemes_localize')?>
							</th>
							<td>
						...
						<tr>
							<th scope="row" style="text-align:right;"><?php _e('Title Attribute:', 'truethemes_localize') ?></th>
							<td><input value="<?php echo $aiosp_titleatr ?>" type="text" name="aiosp_titleatr" size="62"/></td>
						</tr>
						<tr>
							<th scope="row" style="text-align:right;"><?php _e('Menu Label:', 'truethemes_localize') ?></th>
...
<?php
	...
	function options_panel() {
		$message = null;
		//$message_updated = __("All in One SEO Options Updated.", 'truethemes_localize');
		global $aioseop_options;
		...
		if (isset($_POST['action']) && $_POST['action'] == 'aiosp_update' && isset($_POST['Submit_Default'])) {
			...
			$message = __("SEO Settings Reset.", 'truethemes_localize');
		...
		if(isset($_POST['action'])&&isset($_POST['Submit'])){
			if ($_POST['action'] && $_POST['action'] == 'aiosp_update' && $_POST['Submit']!='') {
				$nonce = $_POST['nonce-aioseop'];
				if (!wp_verify_nonce($nonce, 'aioseop-nonce')) die ( 'Security Check - If you receive this in error, log out and back in to WordPress');
				$message = __("SEO Settings Updated.", 'truethemes_localize');
			...
			$message = __("Upgraded to newest version. Please revisit the options page to make sure you see the newest version.", 'truethemes_localize');
			$success = $this->install_newest_version();
			if (!$success) {
				$message = __("Upgrade failed", 'truethemes_localize');
...
<tr>
<th scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Plugin Status:', 'truethemes_localize')?>
</a>
</td>
<td>
<input type="radio" name="aiosp_enabled" value="1" <?php if(@$aioseop_options['aiosp_enabled']) echo "checked"?> > <?php _e('Enabled', 'truethemes_localize'); ?><br>
<input type="radio" name="aiosp_enabled" value="0" <?php if(!@$aioseop_options['aiosp_enabled']) echo "checked"?>> <?php _e('Disabled', 'truethemes_localize'); ?>
<div style="max-width:500px; text-align:left; display:none" id="aiosp_enabled_tip">
<?php
		_e('All in One SEO Pack must be enabled for use.', 'truethemes_localize');
?>
</div>
</td>
</tr>
...
<?php _e('Home Title:', 'truethemes_localize')?>
</td>
<td>
...
<?php
		_e('The &lt;title&gt; of your homepage. This is independent of any other option. If not set, the default blog title will get used.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Home Description:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('The &lt;meta&gt; description for your homepage. Independent of any other options, the default is no &lt;meta&gt; description at all if this is not set.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Home Keywords (comma separated):', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e("A comma separated list of your most important keywords for your site that will be written as &lt;meta&gt; keywords on your homepage.", 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Canonical URLs:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e("This option will automatically generate Canonical URLS for your entire WordPress installation.  This will help to prevent duplicate content penalties by <a href='http://googlewebmastercentral.blogspot.com/2009/02/specify-your-canonical.html' target='_blank'>Google</a>.", 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Rewrite Titles:', 'truethemes_localize')?>
</td>
<td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Post Title Format:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('The following macros are supported:', 'truethemes_localize');
		echo('<ul>');
		echo('<li>'); _e('%blog_title% - Your blog title', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%blog_description% - Your blog description', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%post_title% - The original title of the post', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%category_title% - The (main) category of the post', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%category% - Alias for %category_title%', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e("%post_author_login% - This post's author' login", 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e("%post_author_nicename% - This post's author' nicename", 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e("%post_author_firstname% - This post's author' first name (capitalized)", 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e("%post_author_lastname% - This post's author' last name (capitalized)", 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Page Title Format:', 'truethemes_localize')?>
</td>
<td>
...
<?php
		...
		echo('<li>'); _e('%blog_title% - Your blog title', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%blog_description% - Your blog description', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%page_title% - The original title of the page', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e("%page_author_login% - This page's author' login", 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e("%page_author_nicename% - This page's author' nicename", 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e("%page_author_firstname% - This page's author' first name (capitalized)", 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e("%page_author_lastname% - This page's author' last name (capitalized)", 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Category Title Format:', 'truethemes_localize')?>
</td>
<td>
...
<?php
		...
		echo('<li>'); _e('%blog_title% - Your blog title', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%blog_description% - Your blog description', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%category_title% - The original title of the category', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%category_description% - The description of the category', 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Archive Title Format:', 'truethemes_localize')?>
</td>
<td>
...
<?php
		...
		echo('<li>'); _e('%blog_title% - Your blog title', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%blog_description% - Your blog description', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%date% - The original archive title given by wordpress, e.g. "2007" or "2007 August"', 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Tag Title Format:', 'truethemes_localize')?>
</td>
<td>
...
<?php
		...
		echo('<li>'); _e('%blog_title% - Your blog title', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%blog_description% - Your blog description', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%tag% - The name of the tag', 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Search Title Format:', 'truethemes_localize')?>
</td>
<td>
...
<?php
		...
		echo('<li>'); _e('%blog_title% - Your blog title', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%blog_description% - Your blog description', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%search% - What was searched for', 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Description Format:', 'truethemes_localize')?>
</td>
<td>
...
<?php
		...
		echo('<li>'); _e('%blog_title% - Your blog title', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%blog_description% - Your blog description', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%description% - The original description as determined by the plugin, e.g. the excerpt if one is set or an auto-generated one if that option is set', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%wp_title% - The original wordpress title, e.g. post_title for posts', 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('404 Title Format:', 'truethemes_localize')?>
</td>
<td>
...
<?php
		...
		echo('<li>'); _e('%blog_title% - Your blog title', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%blog_description% - Your blog description', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%request_url% - The original URL path, like "/url-that-does-not-exist/"', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%request_words% - The URL path in human readable form, like "Url That Does Not Exist"', 'truethemes_localize'); echo('</li>');
		echo('<li>'); _e('%404_title% - Additional 404 title input"', 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Paged Format:', 'truethemes_localize')?>
</td>
<td>
...
<span  class="description">
<?php
		_e('This string gets appended/prepended to titles when they are for paged index pages (like home or archive pages).', 'truethemes_localize');
		_e('The following macros are supported:', 'truethemes_localize');
		echo('<ul>');
		echo('<li>'); _e('%page% - The page number', 'truethemes_localize'); echo('</li>');
		echo('</ul>');
?>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('SEO for Custom Post Types:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('Check this if you want your enable AIOSEOP support for Custom Post Types on this site.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Custom Post Types for SEO Column Support:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
			_e('Choose which post types you want to have SEO columns on the edit.php screen. You can select as many as you like.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Use Categories for META keywords:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('Check this if you want your categories for a given post used as the META keywords for this post (in addition to any keywords and tags you specify on the post edit page).', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Use Tags for META keywords:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('Check this if you want your tags for a given post used as the META keywords for this post (in addition to any keywords you specify on the post edit page).', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Dynamically Generate Keywords for Posts Page:', 'truethemes_localize')?>
</td>
<td>
...
<span class='description'>
<?php
		_e('Check this if you want your keywords on a custom posts page (set it in options->reading) to be dynamically generated from the keywords of the posts showing on that page.  If unchecked, it will use the keywords set in the edit page screen for the posts page.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Use noindex for Categories:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('Check this for excluding category pages from being crawled. Useful for avoiding duplicate content.', 'truethemes_localize');
?>
</div>
</span>
<p></p>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Use noindex for Archives:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('Check this for excluding archive pages from being crawled. Useful for avoiding duplicate content.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Use noindex for Tag Archives:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('Check this for excluding tag pages from being crawled. Useful for avoiding duplicate content.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Autogenerate Descriptions:', 'truethemes_localize')?>
</td>
<td>
<input type="checkbox" name="aiosp_generate_descriptions" <?php if (@$aioseop_options['aiosp_generate_descriptions']) echo "checked=\"1\""; ?>/>
<span class="">
<?php
		_e("Check this and your META descriptions will get autogenerated if there's no excerpt.", 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Capitalize Category Titles:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e("Check this and Category Titles will have the first letter of each word capitalized.", 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Exclude Pages:', 'truethemes_localize')?>
</td>
<td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Additional Post Headers:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('What you enter here will be copied verbatim to your header on post pages. You can enter whatever additional headers you want here, even references to stylesheets.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Additional Page Headers:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('What you enter here will be copied verbatim to your header on pages. You can enter whatever additional headers you want here, even references to stylesheets.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<td scope="row" style="text-align:right; vertical-align:top;">
<?php _e('Additional Home Headers:', 'truethemes_localize')?>
</td>
<td>
...
<span class="description">
<?php
		_e('What you enter here will be copied verbatim to your header on the home page. You can enter whatever additional headers you want here, even references to stylesheets.', 'truethemes_localize');
?>
</span>
<p></p>
</td>
...
<tr>
<th scope="row" style="text-align:right; vertical-align:top;">
<a style="cursor:pointer;" title="<?php _e('Click for Help!', 'truethemes_localize')?>" onclick="toggleVisibility('aiosp_do_log_tip');">
<?php _e('Log important events:', 'truethemes_localize')?>
</a>
</td>
<td>
...
<?php
		_e('Check this and SEO pack will create a log of important events (all_in_one_seo_pack.log) in its plugin directory which might help debugging it. Make sure this directory is writable.', 'truethemes_localize');
?>
</div>
</td>
</tr>
...
<input type="submit" class='button-primary' name="Submit" value="<?php _e('Update Settings', 'truethemes_localize')?>" />
<input type="submit" class='button-primary' name="Submit_Default" value="<?php _e('Reset Settings to Defaults', 'truethemes_localize')?>" />
</p>
<?php } ?>
</form>
</div>
