...
( function( $ ) {
	...
	wp.customize( 'theme_blogBox_options[bB_nav_drop_background_hover_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal1 = $('.sf-menu li').css('background-color');
			$( '.sf-menu li' ).mouseenter(function() {
				$(this).css('background-color', newval);
			}).mouseleave(function(){
				$(this).css('background-color', oldVal1);
			});
			var oldVal2 = $('.sub-menu li').css('background-color');
			$( '.sub-menu li' ).mouseenter(function() {
				$(this).css('background-color', newval);
			}).mouseleave(function(){
				$(this).css('background-color', oldVal2);
			});
		});
	} );
	...
	wp.customize( 'theme_blogBox_options[bB_header_hover_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal = $('#header a h1').css('color');
			$( '#header a h1' ).mouseenter(function() {
	...
	//bB_nav_text_hover_color
	wp.customize( 'theme_blogBox_options[bB_nav_text_hover_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal = $('.sf-menu li a').css('color');
			$( '.sf-menu li a' ).mouseenter(function() {
				$(this).css('color', newval);
			}).mouseleave(function(){
				$(this).css('color', oldVal);
			});
	...
	//bB_nav_drop_hover_text_color
	wp.customize( 'theme_blogBox_options[bB_nav_drop_hover_text_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal = $('.sub-menu li a').css('color');
	...
	wp.customize( 'theme_blogBox_options[bB_main_link_color]', function( value ) {
		value.bind( function( newval ) {
			$( '#feature-area a,#widecolumn a,#widecolumn-right a,#fullwidth a,#fullwidth-blog a' ).css('color', newval);
		} );
	} );
	//bB_main_hover_color
	wp.customize( 'theme_blogBox_options[bB_main_hover_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal = $('a').css('color');
	...
	wp.customize( 'theme_blogBox_options[bB_footer_hover_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal = $('#footer a').css('color');
	...
	wp.customize( 'theme_blogBox_options[bB_copyright_hover_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal = $('#copyright a').css('color');
	...
	wp.customize( 'theme_blogBox_options[bB_aside_author_hover_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal = $('.aside-entry .author a').css('color');
			$( '#pagewrap .aside-entry .author a' ).mouseenter(function() {
				$(this).css('color', newval);
			}).mouseleave(function(){
				$(this).css('color', oldVal);
			});
	...
	//bB_link_post_hover_text_color
	wp.customize( 'theme_blogBox_options[bB_link_post_hover_text_color]', function( value ) {
		value.bind( function( newval ) {
			var oldVal = $('.link-entry a').css('color');
			$( '.link-entry a' ).mouseenter(function() {
				$(this).css('color', newval);
			}).mouseleave(function(){
				$(this).css('color', oldVal);
			});
