...
function siteorigin_settings_enqueue_scripts( $prefix ) {
	...
	wp_localize_script( 'siteorigin-settings', 'siteoriginSettings', array(
		...
		'tour' => array(
			'buttonText' => __('Theme Tour', 'origami'),
...
function siteorigin_settings_theme_help(){
	...
	$text = sprintf(
		__( "Read %s's <a href='%s' target='_blank'>theme documentation</a> for help with these settings.", 'origami' ),
		ucfirst($theme_name),
