...
class temptation_Recent_Posts extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'temptation_rp', // Base ID
			__('IH Recent Posts with Thumbnails', 'temptation'), // Name
			array( 'description' => __( 'Display your recent posts, with a Thumbnail.', 'temptation' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
 	...
 	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Latest Articles', 'temptation' );
		}
...
add_action( 'widgets_init', 'register_temptation_widget' );  
function register_temptation_widget() {  
    register_widget( 'Temptation_Recent_Posts' );  
}  
