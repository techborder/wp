...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Market Theme Options', 'optionsframework'),
		'menu_title' => __('Market Settings', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'Market-options',
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Market Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=Market-options' )
		));
}
