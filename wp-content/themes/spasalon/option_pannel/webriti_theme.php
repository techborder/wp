			...
			<div class="row-fluid webriti-container" >				
					<div class="theme-image span3">
						<a target="_blank" href="http://webriti.com/quality/">
							<img src="<?php echo get_template_directory_uri(); ?>/option_pannel/images/quality.png">
						</a>
					</div>
					<div class="theme-info span9">
						<a target="_blank" href="http://webriti.com/quality/" class="theme-name"><h4><?php _e('Quality Pro','sis_spa'); ?></h4></a>								
						<div class="theme-description">
							<p><?php _e('Quality is a Responsive WordPress Theme. It is ideal for Corporate Sector , Business Website.Very Cleaned Design.','sis_spa'); ?></p>
							<p><?php _e('Quality is designed with Readability Flexibility in mind. It is suitable for Business website and other corporate website owner.','sis_spa'); ?></p>
							<p><?php _e('You can build an effective online presence for your business','sis_spa'); ?></p>
						</div>						
						<a target="_blank" href="http://webriti.com/quality/" class="buy btn btn-primary webrit_button"><?php _e('Buy Quality Pro','sis_spa'); ?></a>
						<a target="_blank" href="http://webriti.com/quality/" class="free btn btn-success webrit_button"><?php _e('View Demo','sis_spa'); ?></a>
						<button target="_blank" href="#" class="free btn btn-info webrit_button_new"><?php _e('New Theme','sis_spa'); ?></button>
					</div>
			</div>
			<div class="row-fluid webriti-container" >				
					<div class="theme-image span3">
					...
					<div class="theme-info span9">
						<a target="_blank" href="http://webriti.com/healthcentre/" class="theme-name"><h4><?php _e('Health Centre Pro','sis_spa'); ?></h4></a>								
						<div class="theme-description">
			...
			<div class="row-fluid webriti-container" >				
					<div class="theme-image span3">
						<a target="_blank" href="http://webriti.com/rambo/">
							<img src="<?php echo get_template_directory_uri(); ?>/option_pannel/images/rambo.png">
						</a>
					</div>	
					<div class="theme-info span9">
			...
			<div class="row-fluid webriti-container" >				
					<div class="theme-image span3">
						<a target="_blank" href="http://webriti.com/busiprof/">
							<img src="<?php echo get_template_directory_uri(); ?>/option_pannel/images/busiprof.png">
						</a>
					</div>	
					<div class="theme-info span9">
			...
			<div class="row-fluid webriti-container" >				
					<div class="theme-image span3">
						<a target="_blank" href="http://webriti.com/spasalon/">
							<img src="<?php echo get_template_directory_uri(); ?>/option_pannel/images/spasalon.png">
						</a>
					</div>	
					<div class="theme-info span9">
