 ...
 * @since Catch Evolution 1.4
 */
function catchevolution_reset_all_settings( $input ) {
	if ( $input == 1 ) {
 ...
 * @since Catch Evolution 1.4
 */
function catchevolution_sanitize_important_link() {
	return false;
}
 ...
 * @since Catch Evolution 1.4
 */
function catchevolution_sanitize_reset_featured_image( $input ) {
 ...
 * @since Catch Evolution 1.4
 */
function catchevolution_sanitize_reset_layout( $input ) {
	//Reset Header Featured Image Options
	if( $input == 1 ) {
		global $catchevolution_options_settings, $catchevolution_options_defaults;
 ...
 * @since Catch Evolution 1.4
 */
function catchevolution_sanitize_reset_moretag( $input ) {
	//Reset Header Featured Image Options
	if( $input == 1 ) {
		global $catchevolution_options_settings, $catchevolution_options_defaults;
