...
array(
	'name'     => __('Utility Panel','truethemes_localize'),
	'id'       => 'slider_disable_toolbar',
	'type'     => 'multicheck',
	'options'  => array(
		'true' => __('Check this box to <strong>disable</strong> this page\'s Utility Panel (breadcrumbs, search bar, etc)','truethemes_localize'),
	)
),

array(
	'name' => __('Page Title','truethemes_localize'),
	'desc' => __('Override the Page Title displayed in the Utility Panel.','truethemes_localize'),
	'id'   => '_pagetitle_value',
	'type' => 'text_medium',
),

array(
	'name'    => __('Searchbar','truethemes_localize'),
	'desc'    => __('Should a searchbar be displayed on this page?','truethemes_localize'),
	'id'      => 'banner_search',
	'type'    => 'select',
	'options' => array(
...
array(
	...
	'desc' => __('Display a Full-width Banner with Parallax-style background image. Please note that this is meant to be used in place of a Slider on this page.','truethemes_localize'),
	'type' => 'title',
),
...
array(
	...
	'type'     => 'multicheck',
	'options'  => array(
		'true' => __('Check this box to activate a Parallax Full-width Banner on this page.','truethemes_localize'),
	)
),
...
array(
	...
	'desc' => __('Select a background color for this Parallax Banner area.','truethemes_localize'),
	'type' => 'colorpicker'
),

array(
	'name' => __('Banner BG Image','truethemes_localize'),
	'desc' => __('Upload a background image or leave blank for a solid-color banner area.','truethemes_localize'),
...
array(
	...
	'desc' => __('Define the top and bottom padding of this banner area. (larger number = taller banner)','truethemes_localize'),
...
array(
	...
	'desc' => __('Use these settings to display a Slider on this page. Simply ignore this entire section if not displaying a Slider.','truethemes_localize'),
	'type' => 'title',
),
			
array(
	'name'    => __('Karma jQuery Slider','truethemes_localize'),
	'desc'    => __('<a href="'.get_template_directory_uri().'/framework/screenshots/screenshot-slider-types.png?TB_iframe=false" class="thickbox">View Examples</a>','truethemes_localize'),
...
array(
	'name' => __('Slider BG','truethemes_localize'),
	'id'   => 'truethemes_slider_jq_bgcolor',
	'desc' => __('Select a custom background color for this Karma jQuery (2 or 3) Slider.','truethemes_localize'),
	'type' => 'colorpicker'
),

array(
	'name'     => __('Category','truethemes_localize'),
	'desc'     => __('Which post category should the Karma jQuery Slider use to populate the slides?<br /><strong>Note:</strong> this section lists categories that were created within the \'Slider Posts\' custom post-type','truethemes_localize'),
...
array(
	  ...
	  'desc' => __('Use these settings to display a Gallery on this page. Simply ignore this entire section if do not wish for this to be a Gallery page.<br /><br />* Please use the <strong>Page Attributes</strong> box in the right column of this screen to assign the "Filterable Gallery" <a href="#parent_id">Template</a> for this Gallery page.','truethemes_localize'),
	  'type' => 'title',
  ),
...
array(
	  ...
	  'desc'    => __('Would you like to display the Title below each gallery post?','truethemes_localize'),
...
array(
	  ...
	  'desc'    => __('Would you like to display the Description below each gallery post?','truethemes_localize'),
...
array(
	  'name'     => __('Category','truethemes_localize'),
	  'desc'     => __('Which post category should be used to populate the gallery items? (please select the <strong>parent</strong> category)','truethemes_localize'),
...
$meta_boxes[] = array(
		...
		'title'      => __('Page Styling Options','truethemes_localize'),
		'pages'      => array('page'), // post type
		'context'    => 'normal',
		'priority'   => 'low',
		'show_names' => true,
