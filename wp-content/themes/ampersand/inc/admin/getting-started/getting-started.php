			...
			<div id="help-panel" class="panel visible clearfix">
				<div class="panel-left">
					...
					<div class="arrayvideo">
						<iframe src="http://player.vimeo.com/video/74979150?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="790" height="494" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
					</div>
				...
				<div class="panel-left">
					...
					<p>
						<?php
							...
							printf( __( 'Add your license key to get theme updates without leaving your dashboard! Find your license key in your Array Dashboard in the <a class="thickbox" href="%s">Downloads</a> section. Save your key and then click the Activate button.', 'ampersand' ), esc_url( $license_screenshot ) );
						?>
					</p>
