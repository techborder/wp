<?php
/**
 * Plugin Name: LiveRide Posts-Default Widget
...
class liveride_homepage_default extends WP_Widget {
	function liveride_homepage_default() {
		$widget_ops = array('classname' => 'homepage-default-posts', 'description' => __('Displays the latest posts from the selected category in the default manner.', 'liveride') );
		$control_ops = array('width' => 200, 'height' => 400);
		$this->WP_Widget('liveridedefault', __('LiveRide Posts-Default', 'liveride'), $widget_ops, $control_ops);
	}
