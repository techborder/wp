...
class web_dor_featured_plugins_page_class{

	public function web_dorado_featured_plugins_admin_scripts(){
	
		wp_enqueue_style('web_dorado_featured_plugins_admin_scripts',get_bloginfo('template_directory').'/admin/css/featured_plugins.css');	
	}

	
function dorado_theme_featured_plugins(){
global $web_dor;
?>
	...
	<div id="main_featured_plugins_page">
		...
		<li class="twitter-widget">
                 ...
                 <div class="description">
                                 <p>The Widget Twitter plugin allows you fully integrate your WordPress site with your Twitter account.</p>								 
