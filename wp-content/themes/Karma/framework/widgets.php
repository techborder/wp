...
<?php endif;endforeach;?>
   ...
   {  //@since 4.0.4 dev 5 declare all instance as empty to prevent PHP undefined index notice.
      ...
      $rss = $twitter = $facebook = $flickr = $youtube = $linkedin = $pinterest = $instagram = $foursquare = $delicious = $digg = $google = $dribbble = $skype = $display = $vectorcheckbox = $social_title_checkbox = $colorcheckbox = $ttsocialtarget = '';
      $rss        = $instance['rss'];
...
class SocialMediaWidgetTechborder extends SocialMediaWidget
{
